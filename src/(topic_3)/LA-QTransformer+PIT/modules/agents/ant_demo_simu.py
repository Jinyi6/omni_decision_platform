...
class ANTDemoSimuAgent(nn.Module):
    """
    参数设置
    obs_agent_id: False
    ...
    def __init__(self, input_shape, args):
        super(ANTDemoSimuAgent, self).__init__()
        self.args = args
    ...
    def forward(self, inputs, hidden_state):
        ...
        rnn_input = th.cat([own_feats, ally_embedding_mean, ally_attention_select, enemy_embedding_mean, enemy_embedding_select], dim=-1)
        ...
        return th.cat([self_action, attack_action], dim=-1), own_feats_h, own_selector_feats, ally_embedding, enemy_embedding, own_feature_fc 
