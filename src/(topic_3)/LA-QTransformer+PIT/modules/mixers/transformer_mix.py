...
class TransformerMixer(nn.Module):
    def __init__(self, args):
        ...
        self.enemy_transformer = EncoderLayer(in_dim=self.enemy_dim,
                                              ...
                                              ffn_dim=args.transformer_mix_ffn_dim,
                                              dropout=args.transformer_mix_dropout)
        self.final_attention = MultiHeadAttention(in_dim=args.transformer_mix_model_dim*3,
                                                  model_dim=args.transformer_mix_model_dim*3,
                                                  n_heads=1,
                                                  dropout=args.transformer_mix_dropout,)
    ...
    def forward(self, agent_qs, states):
        ...
        # merge feats
        total_feats = th.cat([agent_feats, enemy_embedding_attention_select, enemy_embedding_last_action_select], dim=-1) # [bs, n_agent, 3*model_dim]
